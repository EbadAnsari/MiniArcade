...
export class OnlineUsers {
	...
	constructor(onlineUsers?: (OnlineUser & TransactionInformation)[]) {
		if (onlineUsers) this.onlineUsers = onlineUsers;
	}

	/**
	 * Sets all the user that ar online.
	 * @param users {OnlineUser & TransactionInformation}
	 */
	setUsers(users: (OnlineUser & TransactionInformation)[]) {
